                    ...
                    if quantity <= available:
                        while True:
                            ...
                            if guests <= (quantity * 3):
                                ...
                                invoice_list.append(
                                    "Sector-4, Dwarka, New Delhi".center(100) + "\n"
                                )
                                invoice_list.append("" + "\n")
                                ...
                                new = str(invoice_no)
                                file = open(
                                    r"D:\Hotel\invoice_" + new + "_" + name + ".txt",
                                    "w",
                                )
                                file.writelines(invoice_list)
                                file.close()
                                delete = (
                                    "UPDATE Room_Details SET Rooms_Available="
                        ...
                        print(
                            "Only", available, "Room/Rooms are available in", room_type
                        )
                break
    ...
    if user == "admin" and passwd == "admin":
        while True:
            ...
            if menu == 1:
                ...
                sql_cursor.execute("USE Hotel")
                sql_cursor.execute(
                    "CREATE TABLE Room_Details (Room_Type CHAR(20), "
